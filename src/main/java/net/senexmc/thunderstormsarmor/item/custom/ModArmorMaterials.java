package net.senexmc.thunderstormsarmor.item.custom;
...
public enum ModArmorMaterials implements ArmorMaterial {
    COPPER("copper", 7, Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
        map.put(ArmorItem.Type.BOOTS, 1);
        map.put(ArmorItem.Type.LEGGINGS, 3);
        map.put(ArmorItem.Type.CHESTPLATE, 5);
        map.put(ArmorItem.Type.HELMET, 2);
    }), 20, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0F, 0.0F, () -> Ingredient.ofItems(Items.COPPER_INGOT));
    ...
    public String getName() {
        return ThunderstormsArmor.MOD_ID + ":" + this.name;
    }
